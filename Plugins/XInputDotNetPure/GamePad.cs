...
namespace XInputDotNetPure
{
    class Imports
    {
        ...
        [DllImport(DLLName)]
        public static extern void UInputGamePadSetState(uint playerIndex, float leftMotor, float rightMotor);
        [DllImport(DLLName)]
        public static extern void UInputUpdate();
        [DllImport(DLLName)]
        public static extern uint UInputGamepadCount();

        public static uint XInputGamePadGetState(uint playerIndex, out GamePadState.RawState state)
        {
            return UInputGamePadGetState(playerIndex, out state);
        }
    ...
    public class GamePad
    {
        ...
        public static int Count
        {
            get
            {
                return (int)Imports.UInputGamepadCount();
            }
        }
    }
}
